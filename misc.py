...
if __name__ == "__main__":
    ...
    # and word variance.
    sigma_i_sq = calculate_sigma_i_sq(vectors_path='vectors.txt', ith_word_id=v, paired_word_ids=word_idx_c, D=50)
    v_cov = calc_dense_var_covar(vectors_path='vectors.txt', ith_word_id=v, paired_word_ids=word_idx_c, D=50)
